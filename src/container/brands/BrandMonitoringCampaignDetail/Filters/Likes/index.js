		...
		return (
			<>
				<Popover className="flex items-center relative">
					<Popover.Button
						className={`${
							payload.likes_to || payload.likes_from
										...
										<div>
											<div className="sm:flex items-center">
												<div className="mb-4 sm:!mb-0">
													<input
														value={payload.likes_from}
														onChange={(e) =>
															this.addPayload("likes_from", e.target.value)
														}
												...
												<div className="ml-0 sm:!ml-4">
													<input
														value={payload.likes_to}
														onChange={(e) =>
															this.addPayload("likes_to", e.target.value)
														}
														placeholder="To"
														className="rounded-[8px] h-[40px] inline-flex w-full items-center px-3 border-[1px] border-[#ced4da] focus-visible:outline-0 focus:border-[#7c3292]"
														type="number"
