...
class BrandInfluencersDiscoverYoutube extends Component {
	constructor(props) {
		super(props);
		this.timeout = 0;
	}
	...
	render() {
		return (
			<>
				<Helmet>
					<meta charSet="utf-8" />
					<title>Discover | Youtube | {process.env.REACT_APP_NAME}</title>
				</Helmet>
				<div className="mb-12">
					<div className="pt-6 bg-white">
						<div className="mb-0">
							...
							<YoutubeFilters customContainer="containers px-0" />
						</div>
					</div>
					<div className="containers">
						<div className="mt-12">
							<YoutubeItems newCampaignWithSelected={true} />
						</div>
					</div>
				</div>
			</>
...
export default connect(
	...
	undefined,
	mergeProps
)(BrandInfluencersDiscoverYoutube);
