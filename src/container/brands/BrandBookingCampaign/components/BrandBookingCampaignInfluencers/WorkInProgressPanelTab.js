...
class WorkInProgressPanelTab extends Component {
	constructor(props) {
		super(props);
		this.state = {
			modalShow: false,
	...
	render() {
		...
		return (
			<div>
				{this.props.inprogressCampaignInfluencers.length ? (
					<div className="mt-12 md:!mt-0">
						...
						{this.props.inprogressCampaignInfluencers.map(
							(influencer, index) => (
										...
										influencer.product.type === "voucher" && (
											<div className="grid grid-cols-12 gap-5 mt-6">
												<div className="lg:col-span-2 col-span-12 flex">
													...
													<Tooltip
														trigger={
															<BsQuestionCircle size={16} className="ml-2" />
														}
...
const mapStateToProps = (state) => {
	return {
		...
		inprogressCampaignInfluencers:
			state.BrandBookingCampaignReducer.inprogressCampaignInfluencers,
