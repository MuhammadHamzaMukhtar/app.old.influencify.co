...
class CanceledPanelTab extends Component {
	constructor(props) {
		super(props);
		this.state = {
			modalShow: false,
	...
	render() {
		...
		return (
			<div>
				{this.props.canceledCampaignInfluencers.length ? (
					<div className="mt-12 md:!mt-0">
						...
						{this.props.canceledCampaignInfluencers.map((influencer, index) => (
...
const mapStateToProps = (state) => {
	return {
		...
		canceledCampaignInfluencers:
			state.BrandBookingCampaignReducer.canceledCampaignInfluencers,
...
export default connect(mapStateToProps, mapDispatchToProps)(CanceledPanelTab);
