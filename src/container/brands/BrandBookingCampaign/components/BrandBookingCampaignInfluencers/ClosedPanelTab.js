...
class ClosedPanelTab extends Component {
	constructor(props) {
		super(props);
		this.state = {
			modalShow: false,
	...
	render() {
		...
		return (
			<div>
				{this.props.closedCampaignInfluencers.length ? (
					<div className="mt-12 md:!mt-0">
						<div className="rounded-[8px] p-3 bg-white lg:block hidden mb-4">
						...
						{this.props.closedCampaignInfluencers.map((influencer, index) => (
...
const mapStateToProps = (state) => {
	return {
		...
		closedCampaignInfluencers:
			state.BrandBookingCampaignReducer.closedCampaignInfluencers,
...
export default connect(mapStateToProps, mapDispatchToProps)(ClosedPanelTab);
