...
class RejectedPanelTab extends Component {
	constructor(props) {
		super(props);
		this.state = {
			modalShow: false,
	...
	render() {
		...
		return (
			<div>
				{this.props.rejectedCampaignInfluencers.length ? (
					<div className="mt-12 md:!mt-0">
						...
						{this.props.rejectedCampaignInfluencers.map((influencer, index) => (
								...
								>
									<div className="lg:col-span-3 md:col-span-5 sm:col-span-4 col-span-11 flex items-center sm:justify-start justify-center">
										<img
											...
											alt={influencer.basicInfo.infl_username}
											src={
...
const mapStateToProps = (state) => {
	return {
		...
		rejectedCampaignInfluencers:
			state.BrandBookingCampaignReducer.rejectedCampaignInfluencers,
...
export default connect(mapStateToProps, mapDispatchToProps)(RejectedPanelTab);
