...
class ClosedInfluencerCampaigns extends Component {
	constructor(props) {
		super(props);
		this.state = {
			openDialog: false,
	...
	onLoadMore = () => {
		if (this.state.limit < (this.props.closedInfluencerCampaigns || []).length) {
			this.setState({
		...
		return (
			<div>
				<div className="grid grid-cols-12 gap-5">
					{(this.props.closedInfluencerCampaigns || []).length > 0 ? (
						this.props.closedInfluencerCampaigns
				...
				{this.state.limit < (this.props.closedInfluencerCampaigns || []).length ? (
