...
class AbortedClosedInfluencerCampaigns extends Component {
	constructor(props) {
		super(props);
		this.state = {
			openDialog: false,
	...
	onLoadMore = () => {
		if (this.state.limit < (this.props.abortedInfluencerCampaigns || []).length) {
			this.setState({
		...
		return (
			<div>
				<div className="grid grid-cols-12 gap-5">
					{(this.props.abortedInfluencerCampaigns || []).length > 0 ? (
						this.props.abortedInfluencerCampaigns
				...
				{this.state.limit < (this.props.abortedInfluencerCampaigns || []).length ? (
