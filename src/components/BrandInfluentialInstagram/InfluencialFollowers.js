...
class InfluencialFollowers extends Component {
	constructor(props) {
		super(props);
		this.timeout = 0;
		this.state = {
	...
	handleChangeFilter = (value) => {
		...
		this.props.handleChangeFollowerFilter(value);
	};
			...
			<>
				<div className="flex flex-wrap">
					<div className="lg:w-9/12 md:w-8/12 w-full order-2 md:!order-1 pr-3">
						{this.props.notableUsers && this.props.notableUsers.length ? (
						...
						{this.props.notableUsers && this.props.notableUsers.length > 0 && (
							<div className="mb-6">
								<label
									htmlFor="selectall"
								...
								>
									<input
										...
										type="checkbox"
										checked={
											this.props.notableUsers.length ===
						...
						<div className="grid grid-cols-12 gap-5 mb-12 relative">
							{this.props.notableUsers && this.props.notableUsers.length ? (
								this.props.notableUsers.map((influencer, index) => (
									<div
						...
						{notableTotalUser > (this.props.notableUsers || []).length && (
							<>
								{!influencialFollowerLoading ? (
									<div className="text-center mb-12">
										<Button
											...
											onClick={this.props.fetchInfluentialFollowers}
											text="Load More"
										/>
									</div>
								) : (
									<div className="pb-12 relative NoBg">
										<div className="py-12">
											<div className="pb-12">
												<Loader
...
const mapStateToProps = (state) => {
	return {
		...
		notableUsers: state.BrandAmbassadorsReducer.notableUsers,
		...
		notableTotalUser: state.BrandAmbassadorsReducer.notableTotalUser,
...
const mapDispatchToProps = (dispatch, ownProps) => {
	...
	return {
		...
		hideCreditsModal: () => dispatch({ type: "HANDLE_HIDE_MODAL" }),
