...
//import YoutubeMiniProfileInfo from "./Sections/YoutubeMiniProfileInfo";
import Blocks from "../Sections/Blocks";
import AudienceGender from "../Sections/AudienceGender";
import AudienceAge from "../Sections/AudienceAge";

class YoutubeMiniProfile extends Component {
	constructor(props) {
		super(props);
			...
			<div className="relative px-10 user-profile-page" id="user-profile-page">
				<div className="pt-6">
					<div className="mt-12 mb-6">
						{/* <YoutubeMiniProfileInfo platform={platform} /> */}
					</div>
...
export default connect(mapStateToProps, null)(YoutubeMiniProfile);
