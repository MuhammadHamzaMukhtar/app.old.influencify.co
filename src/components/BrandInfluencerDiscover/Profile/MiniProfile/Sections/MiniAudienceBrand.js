export default function MiniAudienceBrand() {
	return (
		<div className="bg-white rounded-[8px] p-4 border success-progrss h-full shadow-none">
			<div className="pb-3">
				<h5 className="font-normal text-[16px] darkGray">
					Audience Brand Affinity
				</h5>
			</div>
			<div>
				<div className="flex items-center mb-4">
					<div className="flex items-center col-sm-6 px-0">
						<p className="text-[14px] black font-normal mt-4">Apple</p>
					</div>
					<div className="col-sm-6 px-0 grow mt-4">
				...
				<div className="flex items-center mb-4">
					<div className="flex items-center col-sm-6 px-0">
						<p className="text-[14px] black font-normal mt-4">Lamborghini</p>
					</div>
					<div className="col-sm-6 px-0 grow mt-4">
						<div className="flex items-center">
							<div className="grow">
				...
				<div className="flex items-center mb-4">
					<div className="flex items-center col-sm-6 px-0">
						<p className="text-[14px] black font-normal mt-4">Nike</p>
					</div>
					<div className="col-sm-6 px-0 grow mt-4">
						<div className="flex items-center">
							<div className="grow">
				...
				<div className="flex items-center mb-4">
					<div className="flex items-center col-sm-6 px-0">
						<p className="text-[14px] black font-normal mt-4">Ikea</p>
					</div>
					<div className="col-sm-6 px-0 grow mt-4">
						<div className="flex items-center">
							<div className="grow">
				...
				<div className="flex items-center mb-4">
					<div className="flex items-center col-sm-6 px-0">
						<p className="text-[14px] black font-normal mt-4">Tesla</p>
					</div>
					<div className="col-sm-6 px-0 grow mt-4">
						<div className="flex items-center">
							<div className="grow">
							...
							<div className="text-[14px] black font-normal ml-6">4%</div>
						</div>
					</div>
				</div>
			</div>
