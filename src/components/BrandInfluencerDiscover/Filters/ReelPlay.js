...
class ReelPlay extends Component {
	constructor(props) {
		super(props);
		this.state = {
			left_number: "",
							...
							<div className="flex items-center">
								<div className="w-full">
									<div className="mb-1 font-medium whitespace-nowrap flex items-center justify-between">
										<div className="flex items-center">
											...
											<Tooltip
												...
												tooltipText={tooltip.reels_plays_influencer_tooltip}
												placement="top-left"
											/>
										</div>
									</div>
									<div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
										<Listbox
											onChange={(data) =>
												this.handleSearchFilters(data, "reels_plays", "left")
											}
										>
										...
										<Listbox
											onChange={(data) =>
												this.handleSearchFilters(data, "reels_plays", "right")
											}
										>
											<div className="relative w-full z-50">
												<Listbox.Button className="relative w-full cursor-pointer rounded-lg bg-white py-2 pl-3 pr-6 text-left focus:outline-none border border-[#22242626] h-[40px]">
...
export default connect(mapStateToProps, undefined, mergeProps)(ReelPlay);
